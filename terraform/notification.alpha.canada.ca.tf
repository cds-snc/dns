...
resource "aws_route53_record" "_amazonses.notification.alpha.canada.ca-TXT" {
    zone_id = "${aws_route53_zone.alpha-canada-ca-public.zone_id}"
...
resource "aws_route53_record" "_dkim1.notification.alpha.canada.ca-CNAME" {
    zone_id = "${aws_route53_zone.alpha-canada-ca-public.zone_id}"
...
resource "aws_route53_record" "_dkim2.notification.alpha.canada.ca-CNAME" {
    zone_id = "${aws_route53_zone.alpha-canada-ca-public.zone_id}"
