...
To request a new subdomain, create a `aws_route53_record` terraform entry and submit an ~~pull request~~ [issue](https://github.com/cds-snc/dns/issues/new).  A member of the Platform team will review the request and either approve it, or circle back with additional questions.
